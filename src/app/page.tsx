  ...
  return (
    <div className="flex flex-1 flex-col bg-brand-paper dark:bg-slate-950">
      ...
      <main className="relative flex flex-1 flex-col items-center justify-center overflow-hidden px-6 py-20">
        <Skyline className="pointer-events-none absolute inset-x-0 bottom-0 h-52 w-full sm:h-72" />

        <div className="relative flex flex-col items-center animate-card-in">
      ...
      <footer className="relative border-t border-black/5 px-6 py-6 text-center text-xs text-slate-400 dark:border-white/10 sm:px-10">
